...
public class LevelsMenuScreen implements Screen {
    ...
    public LevelsMenuScreen(Megaman game) {
        this.game = game;
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.batch.draw(background,0,0,Megaman.V_WIDTH,Megaman.V_HEIGHT);
        game.batch.draw(Logo,Megaman.V_WIDTH-1095,Megaman.V_HEIGHT-200,1000,150);
